...
- **Still gated externally (§2):** the real matcher (a hash-matching provider agreement) and clearinghouse reporting. The honest external claim remains *"reactive detection + template-publish review"* — not *"proactive CSAM scanning."*
